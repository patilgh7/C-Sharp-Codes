...
namespace WebFormDictionaryOverList
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // We don't want to building country dictionary every time means loading all dictionary data every time
            // So we are putting this into session.
            // When web form is loaded multiple times this piece of code will not be executed everytime.
            // So the data will loaded once and we can retrieve the data from session.
        ...
        protected void txtCountryCode_TextChanged(object sender, EventArgs e)
        {
            ...
            // ContainsKey(txtCountryCode.Text.ToUpper())
            // => we will get key from that textbox so we mention that textbox id
        ...
        protected void txtCapital_TextChanged()
        {
